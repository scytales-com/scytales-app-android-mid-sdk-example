...
This documentation is based on the [Scytales MID SDK Android Example](../README.md) application, which demonstrates all SDK features with production-ready code examples.

## About This Example

## SDK Reference

- [**SDK API Documentation**](api/index.md) - Complete API reference for all SDK classes and methods
...
- [**Document Issuance**](features/document-issuance.md) - Issue digital credentials using Scytales Manager and OpenID4VCI

Guides for implementing specific SDK features:
...
Essential guides for setting up and initializing the SDK:

## Getting Started

Official documentation for integrating the Scytales Mobile Identity (MID) SDK into Android applications.
